...
export type Result<SuccessValue, FailureValue, InterruptValue> =
	| SuccessResult<SuccessValue>
	| FailureResult<FailureValue>
	| InterruptResult<InterruptValue>

const is_object_with_property = <K extends string>(object: unknown, property: K): object is { [key in K]: unknown } =>
	!!object && typeof object === 'object' && property in object

const is_result = <SuccessValue, FailureValue, InterruptValue>(
	result: unknown,
): result is Result<SuccessValue, FailureValue, InterruptValue> =>
	is_object_with_property(result, 'type') &&
	(result.type === SUCCESS || result.type === FAILURE || result.type === INTERRUPT)
...
const interrupt = <InterruptValue>(value: InterruptValue): InterruptResult<InterruptValue> => ({
	type: INTERRUPT,
	value,
})
...
export const is_success = <SuccessValue, FailureValue, InterruptValue>(
	result: Result<SuccessValue, FailureValue, InterruptValue>,
): result is SuccessResult<SuccessValue> => result.type === SUCCESS
export const is_failure = <SuccessValue, FailureValue, InterruptValue>(
	result: Result<SuccessValue, FailureValue, InterruptValue>,
): result is FailureResult<FailureValue> => result.type === FAILURE
export const is_interrupt = <SuccessValue, FailureValue, InterruptValue>(
	result: Result<SuccessValue, FailureValue, InterruptValue>,
): result is InterruptResult<InterruptValue> => result.type === INTERRUPT

type Middleware<Input, SuccessValue, FailureValue, InterruptValue> = (
	a: Input,
...
async function pipeline<InitialValue, S1, S2, S3, S4, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, S6, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, S6, S7, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, S6, S7, S8, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, S6, S7, S8, S9, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
...
async function pipeline<InitialValue, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, FailureValue, InterruptValue>(
	initial: InitialValue,
	m1: Middleware<InitialValue, S1, FailureValue, InterruptValue>,
	m2: Middleware<S1, S2, FailureValue, InterruptValue>,
	m3: Middleware<S2, S3, FailureValue, InterruptValue>,
